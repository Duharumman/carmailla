...
import 'package:yellow_carmailla/App/Home/car_entries/date_time_picker.dart';
import 'package:yellow_carmailla/App/Home/car_entries/format.dart';
...
class EntryPage extends StatefulWidget {
  const EntryPage({@required this.database, @required this.car, this.entry});
  ...
  static Future<void> show({
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            EntryPage(database: database, car: car, entry: entry),
